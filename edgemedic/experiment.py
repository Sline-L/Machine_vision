...
def main(argv=None):
    ...
    bench = run_suite(reasoner=args.reasoner, llm_url=args.llm_url, l2_always=args.l2_always, cases=cases)
    ...
    payload = {
        "stage": "synthetic+software-inject",
        "status": "implemented-tested",
        "experimentally_validated": False,
        "nx_workload": "future-work",
        ...
        "asr_note": "ASR_function / ASR_mission on live GearPro cycle windows are not claimed. This runner reports synthetic decision metrics only.",
    }
